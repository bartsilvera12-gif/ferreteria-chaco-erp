...
export default function EditarProductoPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5 max-w-5xl hidden">
        {/* Selector de Tipo de producto oculto en Ferretería Chaco — todo es reventa. */}

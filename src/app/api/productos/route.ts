...
export async function POST(request: NextRequest) {
  try {
    ...
    if (typeof body.es_pintura === "boolean") insertPayload.es_pintura = body.es_pintura;
    insertPayload.precio_efectivo = toNumberOrNull(body.precio_efectivo);
    insertPayload.precio_tarjeta = toNumberOrNull(body.precio_tarjeta);
